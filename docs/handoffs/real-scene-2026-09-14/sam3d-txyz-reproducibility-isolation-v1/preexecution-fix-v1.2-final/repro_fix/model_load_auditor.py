...
def run_fresh(a):
 ...
 for i in range(a.runs):
  out=a.output.with_suffix(f'.run{i}.json');cmd=[sys.executable,'-m','repro_fix.model_load_auditor','--worker','--sam-repo',str(a.sam_repo),'--checkpoint',str(a.checkpoint),'--mhr',str(a.mhr),'--output',str(out),'--mode',a.mode];
