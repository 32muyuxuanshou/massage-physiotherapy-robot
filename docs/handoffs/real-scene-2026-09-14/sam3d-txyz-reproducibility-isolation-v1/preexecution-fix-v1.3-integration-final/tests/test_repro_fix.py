...
class Tests(unittest.TestCase):
 ...
 def test_29_dataset_mask_boundary_retained(self):self.assertIn('dataset-mask-assisted', (ROOT/'README_PREEXECUTION_REPRO_FIX_V1_3_INTEGRATION_FINAL.md').read_text())
 def test_30_back_fail_closed(self):self.assertIn('BLOCKED_PENDING_BACK_REGION_DEFINITION',(ROOT/'README_PREEXECUTION_REPRO_FIX_V1_3_INTEGRATION_FINAL.md').read_text())
