...
def verify_assets(paths,freeze):
 ...
 'formal_manifest_sha256':file_sha(paths['formal_manifest']),
  ...
  'repro_code_tree_sha256':tree_sha(paths['repro_code_root'],('*.py',))})
 expected_all={**expected,**{k:gate[k] for k in ('formal_manifest_sha256','txyz_implementation_sha256','camera_calibration_bundle_sha256','repro_code_tree_sha256')}}
