...
def execute(a):
 ...
 return {'status':'PASS_FRAME_ORDER_EXECUTION','design':'three independent processes; seven frames sequentially within one loaded model per process','outputs':outputs}
def main():
 ...
 for n in ('sequences','calibs','sam-repo','checkpoint','mhr','anchor-asset','v23-code','input-snapshot'):p.add_argument('--'+n,type=Path,required=True)
