...
def main() -> None:
    ...
    if extraction.get("status") != "V2_SEALED_DECODE_PASS_GEOMETRY_QA_PENDING":
    ...
    report = {"status": "AUTO_QA_COMPLETE_VISUAL_REVIEW_PENDING", "task": "PUBLIC_RGBD_SINGLE_VS_MULTIVIEW_V2",
              "scope": "V2_SEALED_OPENED_AFTER_WINNER_FREEZE", "sealed_pixels_read": True, "final_reserve_pixels_read": False,
    ...
    write_json(args.output_root / "HUMMAN_V2_SEALED_GEOMETRY_QA_V1.json", report)
